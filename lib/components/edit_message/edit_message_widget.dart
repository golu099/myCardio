...
class _EditMessageWidgetState extends State<EditMessageWidget> {
  ...
  void initState() {
    ...
    _model.personsNameController ??= TextEditingController(text: 'First');
    _model.problemDescriptionController ??=
        TextEditingController(text: 'What\'s your problem?');
  }
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: Text(
                                  'Edit the fields below in order to change your message.',
