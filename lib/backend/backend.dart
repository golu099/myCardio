...
import 'schema/health_tracker_record.dart';
...
export 'schema/health_tracker_record.dart';
...
/// Functions to query HealthTrackerRecords (as a Stream and as a Future).
Future<int> queryHealthTrackerRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HealthTrackerRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HealthTrackerRecord>> queryHealthTrackerRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<HealthTrackerRecord>> queryHealthTrackerRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<HealthTrackerRecord>> queryHealthTrackerRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
